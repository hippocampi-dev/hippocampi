...
import { NPIForm } from "~/components/doctor-onboarding/NPIForm"
import FileViewer from "./FileViewer"

interface NPICredentialViewProps {
  data: NPIForm
}

export function NPICredentialView({ data }: NPICredentialViewProps) {
  return (
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-sm text-muted-foreground">NPI Number</Label>
