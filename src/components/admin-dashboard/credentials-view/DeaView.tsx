...
import { DEAForm } from "~/components/doctor-onboarding/DEAForm"
import FileViewer from "./FileViewer"

interface DEACredentialViewProps {
  data: DEAForm
}

export function DEACredentialView({ data }: DEACredentialViewProps) {
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold mb-4">DEA Information</h3>
            <div className="space-y-4">
              <div>
                <Label className="text-sm text-muted-foreground">DEA Number</Label>
                <p className="font-medium">{data.deaNumber}</p>
              </div>
              <div>
          ...
          <CardContent className="p-6">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-[90vw]">
                <DialogHeader>
                  <DialogTitle>DEA Document</DialogTitle>
                </DialogHeader>
