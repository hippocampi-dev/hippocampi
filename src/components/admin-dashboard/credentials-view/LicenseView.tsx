...
import { LicenseForm } from "~/components/doctor-onboarding/MedicalLicenseForm"
import FileViewer from "./FileViewer"

interface LicenseCredentialViewProps {
  data: LicenseForm
}

export function LicenseCredentialView({ data }: LicenseCredentialViewProps) {
  return (
