...
import { FileUploader } from "~/components/doctor-onboarding/FileUploader"
import { uploadCredentialsFile } from "../../_actions/upload/actions"
...
export default function NPIForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const uploadedFile = await uploadCredentialsFile(session?.user.id!, 'npi-document', file!);
